...
API-first: controller interfaces and request/response contracts are generated by Fabrikt from `src/main/resources/openapi/todo.yaml`. Generated code lives in `src/generated/` — do not edit directly.
